...
func (s *s3Syncer) Sync(ctx context.Context, engine *Engine, app libapp.Application, intermediateRuntimes []semver.Version) error {
...
func (s *S3Syncer) sync(ctx context.Context, engine *Engine, app loc.Locator, cacheApps libapp.Applications) error {
...
// intermediateRuntimes optionally specifies additional runtime application versions to sync.
func (s *PackSyncer) Sync(ctx context.Context, engine *Engine, manifest *schema.Manifest, intermediateRuntimes []semver.Version) error {
	...
	if err := s.syncDeps(ctx, engine, app, cacheApps); err != nil {
...
func (s *PackSyncer) syncDeps(ctx context.Context, engine *Engine, app libapp.Application, cacheApps libapp.Applications) error {
	puller := libapp.Puller{
		FieldLogger: builder.FieldLogger,
		SrcPack:     s.pack,
		SrcApp:      s.apps,
